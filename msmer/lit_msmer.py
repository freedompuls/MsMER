...
from msmer.datamodule import Batch, vocab
from msmer.model.msmer import MsMER
from msmer.utils import ExpRateRecorder, Hypothesis, ce_loss, to_bi_tgt_out


class LitMsMER(pl.LightningModule):
    def __init__(
        self,
        d_model: int,
        # encoder
    ...
    def forward(
        ...
        FloatTensor
            [2b, l, vocab_size]
        """
        return self.msmer(img, img_mask, tgt)
    ...
    def beam_search(
        ...
        hyps = self.msmer.beam_search(img.unsqueeze(0), img_mask, beam_size, max_len)
